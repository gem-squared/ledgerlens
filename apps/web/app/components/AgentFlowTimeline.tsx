...
export const STEP_CATALOG: Array<{
  ...
  { id: 'brightdata_browser',title: 'Bright Data Browser',     hint: 'Rendering the JS-heavy candidate page via Browser API…' },
